...
<<<<<<< HEAD
        this.gui.add(this.scene, 'selectedShape', this.scene.shapesIds).name('Selected Shape').onChange(this.scene.updateShapes.bind(this.scene));
=======
        ...
        this.gui.add(this.scene, 'scaleFactor', 0.5, 10.0).name('Scale Factor');
>>>>>>> main
